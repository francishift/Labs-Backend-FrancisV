...
- **Componente Core (`NotificationDropdown.vue`):** Desplegable estético en el navbar superior. 
    ...
    - Modos de cierre personalizables con estado resiliente: Leer un registro de forma unitaria ya no aborta la navegación interactiva, permitiendo barrer varias en cadena.
...
| `POST`   | `/admin/notifications/mark-all-read`            | `markAllAsRead`  | Acción global del panel Histórico.                            |
