          ...
          <div class="mt-4">
            ...
            >
              <template #cell-aplicacion="{ item }">
                <Link :href="route('admin.mantenimientos.show', item.id)" class="text-emerald-600 hover:text-emerald-900 dark:text-emerald-400 dark:hover:text-emerald-300 font-medium">
                  {{ item.aplicacion }}
                </Link>
              </template>
