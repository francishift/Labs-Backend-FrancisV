    ...
    <AuthenticatedLayout>
        ...
        <div class="py-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Card class="p-4 bg-emerald-600 dark:bg-emerald-600/20 text-white border-none">
                    ...
                    <div class="space-y-4">
                        <div>
                            <p class="text-xs uppercase font-bold opacity-80">Proyectos en Proceso</p>
                            <p class="text-2xl font-black">{{ formatCurrency(activeProjects.reduce((acc, p) => acc + Number(p.presupuesto), 0)) }}</p>
                        </div>
                        <div>
                            <p class="text-xs uppercase font-bold opacity-80">Ingreso Mensual Mant.</p>
                            <p class="text-2xl font-black">
                                {{ formatCurrency(maintenance.reduce((acc, m) => {
